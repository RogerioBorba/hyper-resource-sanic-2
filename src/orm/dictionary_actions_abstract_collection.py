...
dic_abstract_collection_lookup_action: Dict[str, ActionFunction] = {
    ...
    'offsetlimit': ActionFunction('offsetlimit',
                                  ...
                                  representations),
    'limit': ActionFunction('limit',
                                  'limit',
                                  'AbstractCollection',
                                  [ ParamAction('limit', int)],
                                  'Returns a subset of the collection starting limited by limit',
                                  'http://a-server/apis/states/limit/100',
                                  representations),
    'offset': ActionFunction('offset',
                                  'offset',
                                  'AbstractCollection',
                                  [ParamAction('offset', int)],
                                  'Returns a subset of the collection starting in offset.',
                                  'http://a-server/apis/states/offset/10',
                                  representations),
